...
class TestValidatorFunctions(unittest.TestCase):
    ...
    def test_quote_operands(self):
        inp = "name<=john and sophia second=second sixth>sixth seventh<=eighth and ninth path=/home/home_dir/Downloads/Jobs"
        out = [
            'name<="john and sophia"',
            'second="second"',
            'sixth>"sixth"',
            'seventh<="eighth and ninth"',
            'path="/home/home_dir/Downloads/Jobs"',
        ]
        self.assertEqual(list(quote_operands(inp)), out)

        # # TODO refactor code to handle below
        inp2 = "name <= john and sophia second = second third >= third forth != fifth sixth > sixth seventh < eighth and ninth"
        out2 = [
            'name <= "john and sophia"',
            'second = "second"',
            'third >= "third"',
        ...
        self.assertEqual(list(quote_operands(inp2)), out2)

    def test_quote_operands_as_tuple(self):
        inp = "name<=john and sophia second=second sixth>sixth seventh<=eighth and ninth path=/home/home_dir/Downloads/Jobs"
        out = [
            ("name", "<=", '"john and sophia"'),
            ("second", "=", '"second"'),
        ...
        self.assertEqual(list(quote_operands(inp, as_tuple=True)), out)
        #
        #     # TODO refactor code to handle below
        inp2 = "name <= john and sophia second = second third >= third forth != fifth sixth > sixth seventh < eighth and ninth"
        out2 = [
        ...
        self.assertEqual(list(quote_operands(inp2, as_tuple=True)), out2)
